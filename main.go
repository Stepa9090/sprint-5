...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier*r.Training.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Training.Duration.Hours() * MinInHours)
}
...
func (w Walking) Calories() float64 {
	...
	sqMeanSpeed := w.meanSpeed() * KmHInMsec
	// вставьте ваш код ниже
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(sqMeanSpeed, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Training.Duration.Hours() * MinInHours)
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	return (s.Training.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * s.Training.Duration.Hours()
}
